...
export const paths = {
  ...
  dashboard: {
    ...
    organizationDetails: (id: string) => `${ROOTS.DASHBOARD}/organizations/${id}`,
    projectDetails: (id: string) => `${ROOTS.DASHBOARD}/projects/${id}`,
    ...
    experienceReview: (id: string) => `${ROOTS.DASHBOARD}/experience/review/${id}`,
  },
};
